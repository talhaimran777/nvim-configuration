...
_G.packer_plugins = {
  ["Comment.nvim"] = {
    after_files = { "/home/ubuntu/.local/share/nvim/site/pack/packer/opt/Comment.nvim/after/plugin/Comment.lua" },
    config = { "\27LJ\2\nF\0\0\3\0\3\0\0066\0\0\0'\2\1\0B\0\2\0029\0\2\0B\0\1\1K\0\1\0\fcomment\27plugins.configs.others\frequire\0" },
    keys = { { "", "gc" }, { "", "gb" } },
    loaded = false,
    needs_bufread = false,
    only_cond = false,
    path = "/home/ubuntu/.local/share/nvim/site/pack/packer/opt/Comment.nvim",
  ...
  base46 = {
    ...
    loaded = true,
    needs_bufread = false,
    path = "/home/ubuntu/.local/share/nvim/site/pack/packer/opt/base46",
  ...
  ["better-escape.nvim"] = {
    ...
    needs_bufread = false,
    only_cond = false,
    path = "/home/ubuntu/.local/share/nvim/site/pack/packer/opt/better-escape.nvim",
  ...
  extensions = {
    loaded = true,
    path = "/home/ubuntu/.local/share/nvim/site/pack/packer/start/extensions",
  ...
  ["feline.nvim"] = {
    ...
    loaded = true,
    needs_bufread = false,
    path = "/home/ubuntu/.local/share/nvim/site/pack/packer/opt/feline.nvim",
  ...
  ["nvim-lsp-installer"] = {
    ...
    loaded = false,
    needs_bufread = true,
    path = "/home/ubuntu/.local/share/nvim/site/pack/packer/opt/nvim-lsp-installer",
  ...
  nvterm = {
    ...
    loaded = true,
    path = "/home/ubuntu/.local/share/nvim/site/pack/packer/start/nvterm",
